      ...
      if (localImagePath && fs.existsSync(localImagePath)) {
        ...
        return {
          ...
          fields: [
            ...
            { field_name: 'unique_code', field_label: 'Certificate ID', field_type: 'text', x_percent: 50.0, y_percent: 86.0, font_size: 12, font_family: 'Inter, sans-serif', color: '#527A68', align: 'center', is_qr: false },
